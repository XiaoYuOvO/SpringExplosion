...
public class SEEntityTypes {
    ...
    public static final EntityType<FireworkMortarEntity> FIREWORK_MORTAR = Registry.register(Registries.ENTITY_TYPE, new Identifier(SpringExplosion.MOD_ID, "firework_mortar"), EntityType.Builder.create(FireworkMortarEntity::new, SpawnGroup.MISC).setDimensions(0.4F, 0.2F).build("firework_mortar"));
    public static final EntityType<MineEntity> FIREWORK_MINE = Registry.register(Registries.ENTITY_TYPE, new Identifier(SpringExplosion.MOD_ID, "firework_mine"), EntityType.Builder.create(MineEntity::new, SpawnGroup.MISC).setDimensions(0.6F, 0.1F).build("firework_mine"));
