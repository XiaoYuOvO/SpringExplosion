...
public class MineEntity extends OwnedGeoEntity{
    ...
    public boolean ignite(){
        ...
        this.getWorld().createExplosion(this, this.getWorld().getDamageSources().explosion(this, this.getOwner()), new EntityExplosionBehavior(this),this.getX(), this.getY(),this.getZ(), 2.2f, false, World.ExplosionSourceType.MOB, false);
        if (this.getWorld().isClient) {
