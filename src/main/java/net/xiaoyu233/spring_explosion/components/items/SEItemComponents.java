...
public class SEItemComponents {
    ...
    public static final ComponentKey<FirecrackerItemComponent> FIRECRACKER = ComponentRegistry.getOrCreate(new Identifier(SpringExplosion.MOD_ID, "firecracker"), FirecrackerItemComponent.class);
