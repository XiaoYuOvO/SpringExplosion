...
public class GyroItemRenderer extends GeoItemRenderer<GyroItem> {
    public GyroItemRenderer() {
        super(new DefaultedItemGeoModel<>(new Identifier(SpringExplosion.MOD_ID, "gyro")));
    }
}
