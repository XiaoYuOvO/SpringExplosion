...
public class FireCircleEntityModel extends DefaultedEntityGeoModel<FireCircleEntity> {
    public FireCircleEntityModel() {
        super(new Identifier(SpringExplosion.MOD_ID, "fire_circle"));
    }

    @Override
    public void setCustomAnimations(FireCircleEntity animatable, long instanceId, AnimationState<FireCircleEntity> animationState) {
